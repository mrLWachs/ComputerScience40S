...
/**
 * Graphics1.java - this is an example of creating a user interface (UI) with
 * graphical components (tools, etc.) in the form (frame, container, etc.) using
 * purely code (no WYSIWYG designer). This class uses inheritance to inherit 
 * the properties and methods from the JFrame class. This means this class is 
 * the child (sub-class) of the parent class (super class, base class). This 
 * is sometimes simplified to a "is a" relationship.
 *
 * @author Mr. Wachs
 * @since May 30, 2023
 */
public class Graphics1 extends JFrame {
    ...
    private void setControls() {
        ...
        final String FILE = "/computerscience40s/computerscience30s/santa.gif";
