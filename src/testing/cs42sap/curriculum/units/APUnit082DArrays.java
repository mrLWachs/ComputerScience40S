...
public class APUnit082DArrays 
{
    ...
    public APUnit082DArrays() {
        ...
        // (9.1.1) Represent collections of related primitive or object 
        //         reference data using two-dimensional (2D) array objects
            // (9.1.1.1) 2D arrays are stored as arrays of arrays. Therefore, 
            //           the way 2D arrays are created and indexed is similar 
            //           to 1D array objects
            // (9.1.1.2) For the purposes of the exam, when accessing the 
            //           element at arr[first][second], the first index is 
            //           used for rows, the second index is used for columns
            // (9.1.1.3) The initializer list used to create and initialize 
            //           a 2D array consists of initializer lists that 
            //           represent 1D arrays
            // (9.1.1.4) The square brackets [row][col] are used to access 
            //           and modify an element in a 2D array
            // (9.1.1.5) “Row-major order” refers to an ordering of 2D array 
        ...
        // (9.1.1) For 2D array objects: (a) Traverse using nested for loops,
        //         (b) Traverse using nested enhanced for loops
            // (9.1.1.1) Nested iteration statements can be written to traverse 
            //           the 2D array in “row-major order” or “column-major 
            //           order.”
            // (9.1.1.2) The outer loop of a nested enhanced for loop used to 
