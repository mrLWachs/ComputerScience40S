...
public class Teacher extends Person
{
    ...
    public String toString() {
        ...
        for (Student student : students) {
            ...
            // the "student" (no "s") object automatically goes through each
            // element in the array, automatically from the start of the array
            // to the end, changing "student" each time through to each element
            // in order...
