 ...
 * person class. Also it contains contents (a property) which can be 
 * generically anything. To add another generic, use a comma "," in the
 * class signature inside the angle brackets "< >" and another letter
 * to act as another placeholder.
 *
 * @author Mr. Wachs
...
public class House <T extends Person, U>
{
     ...
     * object, a different letter is used
     */
    public U contents;
