        ...
        ExtremeIroning
{
    ...
    /**
     * Signing the permission form (technically this is a mutator method)
     */
    @Override
    public void sign() {
    ...
    public void endOfPeriod(int period) {
        String output = "Hockey: The end of period " + period;
    ...
    /**
     * Checks if the ironing board is valid for the competition
     * 
     * @param inches the length of the board
     * @return 
     */
    @Override
    public boolean isBoardValid(int inches) {
        if (inches >= 50) {
            System.out.println("Extreme Ironing: board valid!");
            return true;
        }
        else {
            System.out.println("Extreme Ironing: board NOT valid!");
            return false;
        }
    }

    /**
     * Set the location for this extreme sport
     * 
     * @param description where it takes place
     */
    @Override
    public void setLocation(String description) {
        System.out.println("Extreme Ironing: at " + description);
    }
